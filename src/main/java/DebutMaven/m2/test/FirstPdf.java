...
public class FirstPdf {
     ...
     * @param truc : String
     */
    public void testmethod(String truc) {
    ...
    /**
     * ajoute les métas data
     * @param document : un Document
     */
